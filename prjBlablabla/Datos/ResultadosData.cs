...
namespace prjBlablabla.Datos
{
    public class ResultadosData
    {
        ...
        public MethodResponseDTO<List<EntGroupChartResult>> GetGrupoResultsBy_EscuelaGrado(int idEscuela,int grado, string grupo, string fechaIni, string fechaFin,string semanaMes, string Escuela)
        {
            try
            {
                ...
                using (var context = new BlablablaSitioEntities())
                {
                    ...
                    foreach (var r in res)
                    {
                        ...
                        resultadosGrupo.Add(new EntGroupChartResult()
                        {
                            ...
                            SemanaMes = semanaMes,
                            PromedioAciertos = Convert.ToInt32(r.totalCorrectos / r.TotalSexo),
                            PromedioErrores = Convert.ToInt32(r.totalIncorrecto / r.TotalSexo),
                        });
                    }
