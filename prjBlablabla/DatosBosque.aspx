<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="DatosBosque.aspx.cs" Inherits="prjBlablabla.DatosBosque" %>
                ...
                <div class="modal-body" id="contAgregar">
                    ...
                    <div class="row" id="fnEnunciados">
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9">
                                <asp:TextBox runat="server" CssClass="form-control" ClientIDMode="Static" ID="Frase" TabIndex="1"></asp:TextBox>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <table id="frasesBosqueTable" class="display" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <asp:Literal runat="server" ID="ltFrasesBosque"></asp:Literal>
                        </tbody>
                    </table>
                </div>
            </div>
