<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="DatosLago.aspx.cs" Inherits="prjBlablabla.DatosLago" %>
                ...
                <div class="modal-body" id="contAgregar">
                    ...
                    <div class="row" id="fnEnunciados">
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-9">
                                <asp:TextBox runat="server" CssClass="form-control" ClientIDMode="Static" ID="Enunciado" TabIndex="1"></asp:TextBox>

                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <label class="col-md-3 control-label">Elección</label>
                            <div class="col-md-9">
                                <asp:CheckBox runat="server" CssClass="form-control" ClientIDMode="Static" ID="Eleccion" TabIndex="2"></asp:CheckBox>
                            </div>
                        </div>
                        <div class="col-xs-12">
                            <div class="col-xs-6 ">
        ...
        <div id="frasesLago">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <button type="button" id="agregarFrasesLago" class="btn btn-primary dropdown-toggle waves-effect waves-light" data-toggle="modal" data-target="#addFrase">Agregar <span class="m-l-5"><i class="fa fa-plus-circle"></i></span></button>
                    </div>
                    <div class="row">
                        <asp:DropDownList runat="server" ID="ddlNivel" CssClass="form-control">
                            <asp:ListItem Text="Nivel 1" Value="1" Selected="True"></asp:ListItem>
                            <asp:ListItem Text="Nivel 2" Value="2"></asp:ListItem>
                            <asp:ListItem Text="Nivel 3" Value="3"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <table id="frasesLagoTable" class="display" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Enunciado</th>
                        ...
                        <tbody>
                            <asp:Literal runat="server" ID="ltFrasesLagoTable"></asp:Literal>
                        </tbody>
                    </table>
                </div>
            </div>
