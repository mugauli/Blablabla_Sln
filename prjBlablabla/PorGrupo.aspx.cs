    ...
    public partial class PorGrupo : System.Web.UI.Page
    {
        ...
        public static string ResultadosPor_EscuelaGrado(int idEscuela, string gradoGrupo, string fechaIni, string fechaFin)
        {
            ...
            foreach (string filter in filterQueryLst)
            {
                ...
                var datostablaResGrupo = new ResultadosData().GetGrupoResultsBy_EscuelaGrado(idEscuela, Convert.ToInt32(grado_grupo[0]), grado_grupo[1], filterSplit[0].Trim(), filterSplit[1].Trim());
            ...
            res = new ResultToGroupo(true, periodosLst.ToArray(), resLst.ToArray(), aciertos, errores);
            System.Web.Script.Serialization.JavaScriptSerializer TheSerializer = new System.Web.Script.Serialization.JavaScriptSerializer();
        ...
        public class ResultToGroupo
        {
            ...
            public ResultToGroupo(bool succes_, string[] periodos_, EntGroupChartResult[] resultados_, int[] aciertos_, int[] errores_)
            {
                success = succes_;
                periodos = periodos_;
                result = resultados_;
